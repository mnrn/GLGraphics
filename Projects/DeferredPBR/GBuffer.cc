...
void GBuffer::OnInit(int w, int h) {
  ...
  textures_[PosTex] = CreateGBufferTexture(GL_TEXTURE0, GL_RGBA32F);
  textures_[NormTex] = CreateGBufferTexture(GL_TEXTURE1, GL_RGBA32F);
  textures_[ColorTex] = CreateGBufferTexture(GL_TEXTURE2, GL_RGBA8);
